 ...
 * @access public
 */
final class social_care_lite_Example_1_Customize {
	...
	public function social_care_lite_sections( $manager ) {
		...
		$manager->register_section_type( 'social_care_lite_Example_1_Customize_Section_Pro' );

		// Register sections.
		$manager->add_section(
			new social_care_lite_Example_1_Customize_Section_Pro(
				$manager,
				'example_1',
				array(
					'title'    => esc_html__( 'Upgrade to Pro', 'social-care-lite' ),
					'pro_text' => esc_html__( 'Upgrade Now', 'social-care-lite' ),
					'pro_url'  => social_care_lite_PROTHEME_URL,
					'priority'   => 1,
				)
			)
		);
...
social_care_lite_Example_1_Customize::social_care_lite_get_instance();