jQuery( document ).ready( function() {
	...
	wp.customize(
		'vw_car_rental_p_letter_spacing',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'vw_car_rental_a_letter_spacing',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'vw_car_rental_h1_letter_spacing',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'vw_car_rental_h2_letter_spacing',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'vw_car_rental_h3_letter_spacing',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'vw_car_rental_vw_car_rental_h4_font_size',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'vw_car_rental_vw_car_rental_h4_line_height',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'vw_car_rental_vw_car_rental_h4_letter_spacing',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'vw_car_rental_vw_car_rental_h5_font_color',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'vw_car_rental_vw_car_rental_h5_font_family',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'vw_car_rental_h5_letter_spacing',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'vw_car_rental_h6_letter_spacing',
		function( value ) {
			value.bind( 
				function( to ) {
